...
exports.sourceNodes = async ({
  ...
  try {
    ...
    const googleDriveFiles = await fetchGoogleDriveFiles({auth, rootFolderIds: options.foldersIds, fields: options.fields, fieldsMapper: options.fieldsMapper, fieldsDefault: options.fieldsDefault})

    const googleDocsDocuments = await fetchGoogleDocsDocuments({auth, apiKey: config.api_key, googleDriveFiles})
